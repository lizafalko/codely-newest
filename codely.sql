...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 07 2017 г., 15:16
...
(115, 'Звезды', '1489488068', 31, 'Звезда́ — излучающий свет, массивный газовый шар, удерживаемый силами собственной гравитации, в недрах которого происходят реакции термоядерного синтеза. Солнце — типичная звезда спектрального класса G. Образуются из газово-пылевой среды в результате гравитационного сжатия.', 4, NULL, 0, 0);
...
(31, 'vienna', 'adele', 'lizafloyd2@gmail.com', NULL, '', '', '', '', '', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 0),
(28, 'Фалько', 'Лиза', 'liza199797@mail.ru', '1997-03-23', 'Образовательные технологии', 'ФСПО ИТМО', '', 'Студентка 4 курса.\r\nПрограммирую своё будущее.', 'http://licensingrussia.ru/wps/wp-content/uploads/2011/06/tumblr_l4lo29uc5v1qzyp47o1_500-275x300.png', '10e2024373b456b407afcf79e3239bdc34f54f174f40465540aee6937070ea40', 0),
...
--
ALTER TABLE `blacklist`
  MODIFY `id_blacklist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
