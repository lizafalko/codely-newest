...
(115, 'Звезды', '1489488068', 31, 'Звезда́ — излучающий свет, массивный газовый шар, удерживаемый силами собственной гравитации, в недрах которого происходят реакции термоядерного синтеза. Солнце — типичная звезда спектрального класса G. Образуются из газово-пылевой среды в результате гравитационного сжатия.', 4, NULL, 0, 1);
